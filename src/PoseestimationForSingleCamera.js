...
const PoseestimationForSingleCamera = () => {
  ...
  return (
    <div style={{display: 'flex'}}>
      <div>
        <h3>Camera 1</h3>
        <video hidden="hidden" ref={videoRef1} width="640" height="480" autoPlay />
        <canvas ref={canvasRef1} width="640" height="480" />
      </div>
      {/* <div>
        <h3>Camera 2</h3>
        <video hidden="hidden" ref={videoRef2} width="640" height="480" autoPlay />
...
export default PoseestimationForSingleCamera;
